...
>>>>>>> b53fe0eb3fa38fdedf40cd956ecd3bada1c24862
  };
...
>>>>>>> b53fe0eb3fa38fdedf40cd956ecd3bada1c24862
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <Navbar />
      <PageHero title="Science Fair Abstract Submission" description="Submit your science fair project abstract and showcase your innovation" />
...
=======
                  <h2 className="text-2xl font-bold text-gray-900 mb-3"> Submit Your Abstract </h2>
                  <p className="text-gray-700 leading-relaxed"> We invite students and innovators to share their groundbreaking projects. Please provide detailed information about your project and upload your abstract in any document format (PDF, Word, Excel, or text). Our team will review your submission and get back to you with results. </p>
>>>>>>> b53fe0eb3fa38fdedf40cd956ecd3bada1c24862
                </div>
              </div>
            </Card>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-900"> Name of School * </label>
                  <Input name="schoolName" value={formData.schoolName} onChange={handleChange} placeholder="Enter your school name" required />
                </div>
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-900"> Student Name * </label>
                  <Input name="studentName" value={formData.studentName} onChange={handleChange} placeholder="Enter student name" required />
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-900"> Name of Teacher or Patron * </label>
                  <Input name="teacherName" value={formData.teacherName} onChange={handleChange} placeholder="Enter teacher or patron name" required />
                </div>
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-900"> Teacher/Patron Email Address * </label>
                  <Input name="teacherEmail" value={formData.teacherEmail} onChange={handleChange} placeholder="teacher@school.ac.ke" type="email" required />
                </div>
              </div>
              <div className="space-y-2">
                <label className="block text-sm font-semibold text-gray-900"> Teacher/Patron Phone Number * </label>
                <Input name="teacherContact" value={formData.teacherContact} onChange={handleChange} placeholder="+254 7XX XXX XXX" type="tel" required />
              </div>
              <div className="space-y-2">
                <label className="block text-sm font-semibold text-gray-900"> Title of Project * </label>
                <Input name="projectTitle" value={formData.projectTitle} onChange={handleChange} placeholder="Enter your project title" required />
              </div>
              <div className="space-y-2">
                <label className="block text-sm font-semibold text-gray-900"> Project Category * </label>
              ...
              <div className="space-y-2">
                <label className="block text-sm font-semibold text-gray-900"> Brief Description of Project * </label>
                <Textarea name="projectDescription" value={formData.projectDescription} onChange={handleChange} placeholder="Provide a brief description of your project (max 500 characters)" maxLength={500} rows={4} required />
                <p className="text-xs text-gray-500"> {formData.projectDescription.length}/500 characters </p>
              </div>
              <div className="space-y-2">
<<<<<<< HEAD
...
=======
                <label className="block text-sm font-semibold text-gray-900"> Abstract Upload (Document) * </label>
                <div className="relative">
                  <input type="file" accept=".pdf,.doc,.docx,.xls,.xlsx,.odt,.txt" onChange={handleFileChange} className="hidden" id="abstract-file" required />
                  <label htmlFor="abstract-file" className="cursor-pointer block">
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-primary hover:bg-primary/5 transition-colors">
                      <Upload className="w-10 h-10 mx-auto text-gray-400 mb-3" />
                      <p className="text-sm font-medium text-gray-900 mb-1"> {fileName || "Click to upload or drag and drop"} </p>
                      <p className="text-xs text-gray-500"> Documents up to 5MB (PDF, Word, Excel, or text) </p>
>>>>>>> b53fe0eb3fa38fdedf40cd956ecd3bada1c24862
                    </div>
                  </label>
                </div>
              ...
              {submissionStatus === "success" && (
                <div className="flex items-start gap-3 p-4 bg-green-50 border border-green-200 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 mt-0.5"> Your abstract has been received. We will review it and get back to you soon. </p>
                  </div>
                </div>
              )}
              {submissionStatus === "error" && (
                <div className="flex items-start gap-3 p-4 bg-red-50 border border-red-200 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700 mt-0.5"> Something went wrong. Please check your connection and try again. </p>
                  </div>
                </div>
              )}
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: true }} className="mt-16 pt-12 border-t border-gray-200">
              ...
              <Card className="p-6 border border-gray-200">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex gap-2">
                    <span className="text-primary font-bold">•</span> Project objective and goals
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-bold">•</span> Methodology and approach
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-bold">•</span> Key findings or results
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-bold">•</span> Impact and significance
                  </li>
                </ul>
              </Card>
              <Card className="p-6 border border-gray-200">
...
=======
                    <span className="text-primary font-bold">•</span> Supported formats: PDF, Word, Excel, or text
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-bold">•</span> Maximum 5MB file size
>>>>>>> b53fe0eb3fa38fdedf40cd956ecd3bada1c24862
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-bold">•</span> 200-300 words recommended
                  </li>
                  <li className="flex gap-2">
                    <span className="text-primary font-bold">•</span> Clear and concise language
                  </li>
                </ul>
              </Card>
            </div>
